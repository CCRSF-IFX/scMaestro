...
snakemake -s workflow_ext/Snakefile4test_ext --configfile config4test_3sample.ext.yaml --forceall -j 1 test_sc_rna_fullanalysis
...
snakemake -s workflow_ext/Snakefile4test_ext --configfile config4test_3sample.ext.yaml --forceall -j 1 test_sc_fixedrna_singleplex_default
